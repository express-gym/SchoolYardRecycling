 ...
 *  static method.
 */
class Carbon_Reports extends Rest implements iRestNoPrimaryKey
{
    ...
    public const TABLE_NAME = 'recycling_carbon_reports';
    ...
    **/
    ...
    /**
     * COLUMNS
     * The columns below are a 1=1 mapping to the columns found in recycling_carbon_reports. 
    ...
    **/
    public const LOG_LEVEL = 'recycling_carbon_reports.log_level'; 

    public const REPORT = 'recycling_carbon_reports.report'; 

    public const DATE = 'recycling_carbon_reports.date'; 

    public const CALL_TRACE = 'recycling_carbon_reports.call_trace'; 
     ...
     *
     *    public Carbon_Reports $recycling_carbon_reports;
     *
     * The definition above can be defined with the following ::
     *
     *    $recycling_carbon_reports = new Carbon_Reports($return);
     *
