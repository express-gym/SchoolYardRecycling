 ...
 *  static method.
 */
class Carbon_Carbons extends Rest implements iRestSinglePrimaryKey
{
    use RestfulValidations;
    
    public const CLASS_NAME = 'Carbon_Carbons';
    
    public const CLASS_NAMESPACE = 'Recycling\\';
    
    public const TABLE_NAME = 'recycling_carbon_carbons';
    ...
    public const INTERNAL_TABLE_CONSTRAINTS = [
        self::ENTITY_FK => Carbon_Carbons::ENTITY_PK,
    ];
    ...
    public const EXTERNAL_TABLE_CONSTRAINTS = [
        ...
        Carbon_Comments::COMMENT_ID => self::ENTITY_PK,
        Carbon_Comments::PARENT_ID => self::ENTITY_PK,
        Carbon_Comments::USER_ID => self::ENTITY_PK,
        Carbon_Feature_Group_References::GROUP_ENTITY_ID => self::ENTITY_PK,
        Carbon_Feature_Group_References::FEATURE_ENTITY_ID => self::ENTITY_PK,
        Carbon_Features::FEATURE_ENTITY_ID => self::ENTITY_PK,
        Carbon_Group_References::GROUP_ID => self::ENTITY_PK,
        Carbon_Group_References::ALLOWED_TO_GRANT_GROUP_ID => self::ENTITY_PK,
        Carbon_Groups::ENTITY_ID => self::ENTITY_PK,
        Carbon_Groups::CREATED_BY => self::ENTITY_PK,
        Carbon_Location_References::ENTITY_REFERENCE => self::ENTITY_PK,
        Carbon_Location_References::LOCATION_REFERENCE => self::ENTITY_PK,
        Carbon_Locations::ENTITY_ID => self::ENTITY_PK,
        Carbon_Photos::PHOTO_ID => self::ENTITY_PK,
        Carbon_Photos::PARENT_ID => self::ENTITY_PK,
        Carbon_Photos::USER_ID => self::ENTITY_PK,
        Carbon_User_Followers::FOLLOWER_TABLE_ID => self::ENTITY_PK,
        Carbon_User_Followers::FOLLOWS_USER_ID => self::ENTITY_PK,
        Carbon_User_Followers::USER_ID => self::ENTITY_PK,
        Carbon_User_Groups::GROUP_ID => self::ENTITY_PK,
        Carbon_User_Groups::USER_ID => self::ENTITY_PK,
        Carbon_User_Messages::FROM_USER_ID => self::ENTITY_PK,
        Carbon_User_Messages::MESSAGE_ID => self::ENTITY_PK,
        Carbon_User_Messages::TO_USER_ID => self::ENTITY_PK,
        Carbon_User_Tasks::TASK_ID => self::ENTITY_PK,
        Carbon_User_Tasks::USER_ID => self::ENTITY_PK,
        Carbon_User_Tasks::FROM_ID => self::ENTITY_PK,
        Carbon_Users::USER_ID => self::ENTITY_PK,
    ];
    ...
    **/
    ...
    /**
     * COLUMNS
     * The columns below are a 1=1 mapping to the columns found in recycling_carbon_carbons. 
    ...
    **/
    public const ENTITY_PK = 'recycling_carbon_carbons.entity_pk'; 

    public const ENTITY_FK = 'recycling_carbon_carbons.entity_fk'; 

    public const ENTITY_TAG = 'recycling_carbon_carbons.entity_tag'; 
     ...
     *
     *    public Carbon_Carbons $recycling_carbon_carbons;
     *
     * The definition above can be defined with the following ::
     *
     *    $recycling_carbon_carbons = new Carbon_Carbons($return);
     *
    ...
    **/
    public const PRIMARY = 'recycling_carbon_carbons.entity_pk';
    ...
    **/
    public const PDO_VALIDATION = [
        self::ENTITY_PK => [self::MYSQL_TYPE => 'binary', self::PDO_TYPE => PDO::PARAM_STR, self::MAX_LENGTH => '16', self::AUTO_INCREMENT => false, self::SKIP_COLUMN_IN_POST => false],
        self::ENTITY_FK => [self::MYSQL_TYPE => 'binary', self::PDO_TYPE => PDO::PARAM_STR, self::MAX_LENGTH => '16', self::AUTO_INCREMENT => false, self::SKIP_COLUMN_IN_POST => false, self::DEFAULT_POST_VALUE => null],
        self::ENTITY_TAG => [self::MYSQL_TYPE => 'varchar', self::PDO_TYPE => PDO::PARAM_STR, self::MAX_LENGTH => '100', self::AUTO_INCREMENT => false, self::SKIP_COLUMN_IN_POST => false, self::DEFAULT_POST_VALUE => 'manually'],
    ];
