...
/**
 *
 * Class Carbon_Feature_Group_References
 * @package Recycling
 ...
 *  static method.
 */
class Carbon_Feature_Group_References extends Rest implements iRestNoPrimaryKey
{
    ...
    public const TABLE_NAME = 'recycling_carbon_feature_group_references';
    ...
    public const INTERNAL_TABLE_CONSTRAINTS = [
        self::GROUP_ENTITY_ID => Carbon_Carbons::ENTITY_PK,
        self::FEATURE_ENTITY_ID => Carbon_Carbons::ENTITY_PK,
    ];
    ...
    **/
    ...
    /**
     * COLUMNS
     * The columns below are a 1=1 mapping to the columns found in recycling_carbon_feature_group_references. 
    ...
    **/
    public const FEATURE_ENTITY_ID = 'recycling_carbon_feature_group_references.feature_entity_id'; 

    public const GROUP_ENTITY_ID = 'recycling_carbon_feature_group_references.group_entity_id'; 
     ...
     *
     *    public Carbon_Feature_Group_References $recycling_carbon_feature_group_references;
     *
     * The definition above can be defined with the following ::
     *
     *    $recycling_carbon_feature_group_references = new Carbon_Feature_Group_References($return);
     *
    ...
    **/
    public const PDO_VALIDATION = [
        self::FEATURE_ENTITY_ID => [self::MYSQL_TYPE => 'binary', self::PDO_TYPE => PDO::PARAM_STR, self::MAX_LENGTH => '16', self::AUTO_INCREMENT => false, self::SKIP_COLUMN_IN_POST => false, self::DEFAULT_POST_VALUE => null],
        self::GROUP_ENTITY_ID => [self::MYSQL_TYPE => 'binary', self::PDO_TYPE => PDO::PARAM_STR, self::MAX_LENGTH => '16', self::AUTO_INCREMENT => false, self::SKIP_COLUMN_IN_POST => false, self::DEFAULT_POST_VALUE => null],
    ];
