...
class Carbon_Photos extends Rest implements iRestSinglePrimaryKey
{
    ...
    public const TABLE_NAME = 'recycling_carbon_photos';
    ...
    public const INTERNAL_TABLE_CONSTRAINTS = [
        self::PHOTO_ID => Carbon_Carbons::ENTITY_PK,
    ...
    **/
    ...
    /**
     * COLUMNS
     * The columns below are a 1=1 mapping to the columns found in recycling_carbon_photos. 
    ...
    **/
    public const PARENT_ID = 'recycling_carbon_photos.parent_id'; 

    public const PHOTO_ID = 'recycling_carbon_photos.photo_id'; 

    public const USER_ID = 'recycling_carbon_photos.user_id'; 

    public const PHOTO_PATH = 'recycling_carbon_photos.photo_path'; 

    public const PHOTO_DESCRIPTION = 'recycling_carbon_photos.photo_description'; 
     ...
     *
     *    public Carbon_Photos $recycling_carbon_photos;
     *
     * The definition above can be defined with the following ::
     *
     *    $recycling_carbon_photos = new Carbon_Photos($return);
     *
    ...
    **/
    public const PRIMARY = 'recycling_carbon_photos.parent_id';
