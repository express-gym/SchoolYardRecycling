...
class Carbon_User_Messages extends Rest implements iRestSinglePrimaryKey
{
    ...
    public const TABLE_NAME = 'recycling_carbon_user_messages';
    ...
    public const INTERNAL_TABLE_CONSTRAINTS = [
        self::FROM_USER_ID => Carbon_Carbons::ENTITY_PK,
        self::MESSAGE_ID => Carbon_Carbons::ENTITY_PK,
        self::TO_USER_ID => Carbon_Carbons::ENTITY_PK,
    ];
    ...
    **/
    ...
    /**
     * COLUMNS
     * The columns below are a 1=1 mapping to the columns found in recycling_carbon_user_messages. 
    ...
    **/
    public const MESSAGE_ID = 'recycling_carbon_user_messages.message_id'; 

    public const FROM_USER_ID = 'recycling_carbon_user_messages.from_user_id'; 

    public const TO_USER_ID = 'recycling_carbon_user_messages.to_user_id'; 

    public const MESSAGE = 'recycling_carbon_user_messages.message'; 

    public const MESSAGE_READ = 'recycling_carbon_user_messages.message_read'; 

    public const CREATION_DATE = 'recycling_carbon_user_messages.creation_date'; 
     ...
     *
     *    public Carbon_User_Messages $recycling_carbon_user_messages;
     *
     * The definition above can be defined with the following ::
     *
     *    $recycling_carbon_user_messages = new Carbon_User_Messages($return);
     *
    ...
    **/
    public const PRIMARY = 'recycling_carbon_user_messages.message_id';
    ...
    **/
    public const PDO_VALIDATION = [
        ...
        self::MESSAGE_READ => [self::MYSQL_TYPE => 'tinyint', self::PDO_TYPE => PDO::PARAM_INT, self::MAX_LENGTH => '4', self::AUTO_INCREMENT => false, self::SKIP_COLUMN_IN_POST => false, self::DEFAULT_POST_VALUE => '0'],
