...
class Carbon_User_Tasks extends Rest implements iRestSinglePrimaryKey
{
    ...
    public const TABLE_NAME = 'recycling_carbon_user_tasks';
    ...
    public const INTERNAL_TABLE_CONSTRAINTS = [
        self::TASK_ID => Carbon_Carbons::ENTITY_PK,
        self::USER_ID => Carbon_Carbons::ENTITY_PK,
        self::FROM_ID => Carbon_Carbons::ENTITY_PK,
    ];
    ...
    **/
    ...
    /**
     * COLUMNS
     * The columns below are a 1=1 mapping to the columns found in recycling_carbon_user_tasks. 
    ...
    **/
    public const TASK_ID = 'recycling_carbon_user_tasks.task_id'; 

    public const USER_ID = 'recycling_carbon_user_tasks.user_id'; 

    public const FROM_ID = 'recycling_carbon_user_tasks.from_id'; 

    public const TASK_NAME = 'recycling_carbon_user_tasks.task_name'; 

    public const TASK_DESCRIPTION = 'recycling_carbon_user_tasks.task_description'; 

    public const PERCENT_COMPLETE = 'recycling_carbon_user_tasks.percent_complete'; 

    public const START_DATE = 'recycling_carbon_user_tasks.start_date'; 

    public const END_DATE = 'recycling_carbon_user_tasks.end_date'; 
     ...
     *
     *    public Carbon_User_Tasks $recycling_carbon_user_tasks;
     *
     * The definition above can be defined with the following ::
     *
     *    $recycling_carbon_user_tasks = new Carbon_User_Tasks($return);
     *
    ...
    **/
    public const PRIMARY = 'recycling_carbon_user_tasks.task_id';
    ...
    **/
    public const PDO_VALIDATION = [
        self::TASK_ID => [self::MYSQL_TYPE => 'binary', self::PDO_TYPE => PDO::PARAM_STR, self::MAX_LENGTH => '16', self::AUTO_INCREMENT => false, self::SKIP_COLUMN_IN_POST => false],
        ...
        self::FROM_ID => [self::MYSQL_TYPE => 'binary', self::PDO_TYPE => PDO::PARAM_STR, self::MAX_LENGTH => '16', self::AUTO_INCREMENT => false, self::SKIP_COLUMN_IN_POST => false, self::DEFAULT_POST_VALUE => null],
        self::TASK_NAME => [self::MYSQL_TYPE => 'varchar', self::PDO_TYPE => PDO::PARAM_STR, self::MAX_LENGTH => '40', self::AUTO_INCREMENT => false, self::SKIP_COLUMN_IN_POST => false],
        self::TASK_DESCRIPTION => [self::MYSQL_TYPE => 'varchar', self::PDO_TYPE => PDO::PARAM_STR, self::MAX_LENGTH => '225', self::AUTO_INCREMENT => false, self::SKIP_COLUMN_IN_POST => false, self::DEFAULT_POST_VALUE => null],
        self::PERCENT_COMPLETE => [self::MYSQL_TYPE => 'int', self::PDO_TYPE => PDO::PARAM_INT, self::MAX_LENGTH => '11', self::AUTO_INCREMENT => false, self::SKIP_COLUMN_IN_POST => false, self::DEFAULT_POST_VALUE => '0'],
        self::START_DATE => [self::MYSQL_TYPE => 'datetime', self::PDO_TYPE => PDO::PARAM_STR, self::MAX_LENGTH => '', self::AUTO_INCREMENT => false, self::SKIP_COLUMN_IN_POST => false, self::DEFAULT_POST_VALUE => null],
        self::END_DATE => [self::MYSQL_TYPE => 'datetime', self::PDO_TYPE => PDO::PARAM_STR, self::MAX_LENGTH => '', self::AUTO_INCREMENT => false, self::SKIP_COLUMN_IN_POST => false, self::DEFAULT_POST_VALUE => null],
    ];
