 ...
 *  static method.
 */
class Carbon_Comments extends Rest implements iRestSinglePrimaryKey
{
    ...
    public const TABLE_NAME = 'recycling_carbon_comments';
    ...
    public const INTERNAL_TABLE_CONSTRAINTS = [
        self::COMMENT_ID => Carbon_Carbons::ENTITY_PK,
        self::PARENT_ID => Carbon_Carbons::ENTITY_PK,
    ...
    **/
    ...
    /**
     * COLUMNS
     * The columns below are a 1=1 mapping to the columns found in recycling_carbon_comments. 
    ...
    **/
    public const PARENT_ID = 'recycling_carbon_comments.parent_id'; 

    public const COMMENT_ID = 'recycling_carbon_comments.comment_id'; 

    public const USER_ID = 'recycling_carbon_comments.user_id'; 

    public const COMMENT = 'recycling_carbon_comments.comment'; 
     ...
     *
     *    public Carbon_Comments $recycling_carbon_comments;
     *
     * The definition above can be defined with the following ::
     *
     *    $recycling_carbon_comments = new Carbon_Comments($return);
     *
    ...
    **/
    public const PRIMARY = 'recycling_carbon_comments.comment_id';
    ...
    **/
    public const PDO_VALIDATION = [
        self::PARENT_ID => [self::MYSQL_TYPE => 'binary', self::PDO_TYPE => PDO::PARAM_STR, self::MAX_LENGTH => '16', self::AUTO_INCREMENT => false, self::SKIP_COLUMN_IN_POST => false],
        self::COMMENT_ID => [self::MYSQL_TYPE => 'binary', self::PDO_TYPE => PDO::PARAM_STR, self::MAX_LENGTH => '16', self::AUTO_INCREMENT => false, self::SKIP_COLUMN_IN_POST => false],
        ...
        self::COMMENT => [self::MYSQL_TYPE => 'blob', self::PDO_TYPE => PDO::PARAM_STR, self::MAX_LENGTH => '', self::AUTO_INCREMENT => false, self::SKIP_COLUMN_IN_POST => false],
    ];
