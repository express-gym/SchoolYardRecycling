...
class Carbon_Location_References extends Rest implements iRestNoPrimaryKey
{
    ...
    public const TABLE_NAME = 'recycling_carbon_location_references';
    ...
    public const INTERNAL_TABLE_CONSTRAINTS = [
        self::ENTITY_REFERENCE => Carbon_Carbons::ENTITY_PK,
        self::LOCATION_REFERENCE => Carbon_Carbons::ENTITY_PK,
    ];
    ...
    **/
    ...
    /**
     * COLUMNS
     * The columns below are a 1=1 mapping to the columns found in recycling_carbon_location_references. 
    ...
    **/
    public const ENTITY_REFERENCE = 'recycling_carbon_location_references.entity_reference'; 

    public const LOCATION_REFERENCE = 'recycling_carbon_location_references.location_reference'; 

    public const LOCATION_TIME = 'recycling_carbon_location_references.location_time'; 
     ...
     *
     *    public Carbon_Location_References $recycling_carbon_location_references;
     *
     * The definition above can be defined with the following ::
     *
     *    $recycling_carbon_location_references = new Carbon_Location_References($return);
     *
    ...
    **/
    public const PDO_VALIDATION = [
        self::ENTITY_REFERENCE => [self::MYSQL_TYPE => 'binary', self::PDO_TYPE => PDO::PARAM_STR, self::MAX_LENGTH => '16', self::AUTO_INCREMENT => false, self::SKIP_COLUMN_IN_POST => false],
        self::LOCATION_REFERENCE => [self::MYSQL_TYPE => 'binary', self::PDO_TYPE => PDO::PARAM_STR, self::MAX_LENGTH => '16', self::AUTO_INCREMENT => false, self::SKIP_COLUMN_IN_POST => false],
        self::LOCATION_TIME => [self::MYSQL_TYPE => 'datetime', self::PDO_TYPE => PDO::PARAM_STR, self::MAX_LENGTH => '', self::AUTO_INCREMENT => false, self::SKIP_COLUMN_IN_POST => true, self::DEFAULT_POST_VALUE => self::CURRENT_TIMESTAMP],
    ];
