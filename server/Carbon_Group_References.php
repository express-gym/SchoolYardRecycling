...
class Carbon_Group_References extends Rest implements iRestNoPrimaryKey
{
    ...
    public const TABLE_NAME = 'recycling_carbon_group_references';
    ...
    public const INTERNAL_TABLE_CONSTRAINTS = [
        ...
        self::ALLOWED_TO_GRANT_GROUP_ID => Carbon_Carbons::ENTITY_PK,
    ];
    ...
    **/
    ...
    /**
     * COLUMNS
     * The columns below are a 1=1 mapping to the columns found in recycling_carbon_group_references. 
    ...
    **/
    public const GROUP_ID = 'recycling_carbon_group_references.group_id'; 

    public const ALLOWED_TO_GRANT_GROUP_ID = 'recycling_carbon_group_references.allowed_to_grant_group_id'; 
     ...
     *
     *    public Carbon_Group_References $recycling_carbon_group_references;
     *
     * The definition above can be defined with the following ::
     *
     *    $recycling_carbon_group_references = new Carbon_Group_References($return);
     *
