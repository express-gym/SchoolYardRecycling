 ...
 *  static method.
 */
class Carbon_User_Followers extends Rest implements iRestSinglePrimaryKey
{
    ...
    public const TABLE_NAME = 'recycling_carbon_user_followers';
    ...
    public const INTERNAL_TABLE_CONSTRAINTS = [
        self::FOLLOWER_TABLE_ID => Carbon_Carbons::ENTITY_PK,
        self::FOLLOWS_USER_ID => Carbon_Carbons::ENTITY_PK,
    ...
    **/
    ...
    /**
     * COLUMNS
     * The columns below are a 1=1 mapping to the columns found in recycling_carbon_user_followers. 
    ...
    **/
    public const FOLLOWER_TABLE_ID = 'recycling_carbon_user_followers.follower_table_id'; 

    public const FOLLOWS_USER_ID = 'recycling_carbon_user_followers.follows_user_id'; 

    public const USER_ID = 'recycling_carbon_user_followers.user_id'; 
     ...
     *
     *    public Carbon_User_Followers $recycling_carbon_user_followers;
     *
     * The definition above can be defined with the following ::
     *
     *    $recycling_carbon_user_followers = new Carbon_User_Followers($return);
     *
    ...
    **/
    public const PRIMARY = 'recycling_carbon_user_followers.follower_table_id';
    ...
    **/
    public const PDO_VALIDATION = [
        self::FOLLOWER_TABLE_ID => [self::MYSQL_TYPE => 'binary', self::PDO_TYPE => PDO::PARAM_STR, self::MAX_LENGTH => '16', self::AUTO_INCREMENT => false, self::SKIP_COLUMN_IN_POST => false],
        self::FOLLOWS_USER_ID => [self::MYSQL_TYPE => 'binary', self::PDO_TYPE => PDO::PARAM_STR, self::MAX_LENGTH => '16', self::AUTO_INCREMENT => false, self::SKIP_COLUMN_IN_POST => false],
