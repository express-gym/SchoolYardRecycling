 ...
 *  static method.
 */
class Carbon_User_Groups extends Rest implements iRestNoPrimaryKey
{
    ...
    public const TABLE_NAME = 'recycling_carbon_user_groups';
    ...
    public const INTERNAL_TABLE_CONSTRAINTS = [
        self::GROUP_ID => Carbon_Carbons::ENTITY_PK,
    ...
    **/
    ...
    /**
     * COLUMNS
     * The columns below are a 1=1 mapping to the columns found in recycling_carbon_user_groups. 
    ...
    **/
    public const GROUP_ID = 'recycling_carbon_user_groups.group_id'; 

    public const USER_ID = 'recycling_carbon_user_groups.user_id'; 
     ...
     *
     *    public Carbon_User_Groups $recycling_carbon_user_groups;
     *
     * The definition above can be defined with the following ::
     *
     *    $recycling_carbon_user_groups = new Carbon_User_Groups($return);
     *
    ...
    **/
    public const PDO_VALIDATION = [
        ...
        self::USER_ID => [self::MYSQL_TYPE => 'binary', self::PDO_TYPE => PDO::PARAM_STR, self::MAX_LENGTH => '16', self::AUTO_INCREMENT => false, self::SKIP_COLUMN_IN_POST => false, self::DEFAULT_POST_VALUE => null],
    ];
