 ...
 *  static method.
 */
class Carbon_Sessions extends Rest implements iRestSinglePrimaryKey
{
    use RestfulValidations;
    
    public const CLASS_NAME = 'Carbon_Sessions';
    
    public const CLASS_NAMESPACE = 'Recycling\\';
    
    public const TABLE_NAME = 'recycling_carbon_sessions';
    ...
    **/
    ...
    /**
     * COLUMNS
     * The columns below are a 1=1 mapping to the columns found in recycling_carbon_sessions. 
    ...
    **/
    public const USER_ID = 'recycling_carbon_sessions.user_id'; 

    public const USER_IP = 'recycling_carbon_sessions.user_ip'; 

    public const SESSION_ID = 'recycling_carbon_sessions.session_id'; 

    public const SESSION_EXPIRES = 'recycling_carbon_sessions.session_expires'; 

    public const SESSION_DATA = 'recycling_carbon_sessions.session_data'; 

    public const USER_ONLINE_STATUS = 'recycling_carbon_sessions.user_online_status'; 
     ...
     *
     *    public Carbon_Sessions $recycling_carbon_sessions;
     *
     * The definition above can be defined with the following ::
     *
     *    $recycling_carbon_sessions = new Carbon_Sessions($return);
     *
    ...
    **/
    public const PRIMARY = 'recycling_carbon_sessions.session_id';
    ...
    **/
    public const PDO_VALIDATION = [
        ...
        self::USER_IP => [self::MYSQL_TYPE => 'varchar', self::PDO_TYPE => PDO::PARAM_STR, self::MAX_LENGTH => '20', self::AUTO_INCREMENT => false, self::SKIP_COLUMN_IN_POST => false, self::DEFAULT_POST_VALUE => null],
        ...
        self::USER_ONLINE_STATUS => [self::MYSQL_TYPE => 'tinyint', self::PDO_TYPE => PDO::PARAM_INT, self::MAX_LENGTH => '4', self::AUTO_INCREMENT => false, self::SKIP_COLUMN_IN_POST => false, self::DEFAULT_POST_VALUE => '1'],
    ];
