...
class Carbon_Features extends Rest implements iRestSinglePrimaryKey
{
    ...
    public const TABLE_NAME = 'recycling_carbon_features';
    ...
    **/
    ...
    /**
     * COLUMNS
     * The columns below are a 1=1 mapping to the columns found in recycling_carbon_features. 
    ...
    **/
    public const FEATURE_ENTITY_ID = 'recycling_carbon_features.feature_entity_id'; 

    public const FEATURE_CODE = 'recycling_carbon_features.feature_code'; 

    public const FEATURE_CREATION_DATE = 'recycling_carbon_features.feature_creation_date'; 
     ...
     *
     *    public Carbon_Features $recycling_carbon_features;
     *
     * The definition above can be defined with the following ::
     *
     *    $recycling_carbon_features = new Carbon_Features($return);
     *
    ...
    **/
    public const PRIMARY = 'recycling_carbon_features.feature_entity_id';
    ...
    **/
    public const PDO_VALIDATION = [
        self::FEATURE_ENTITY_ID => [self::MYSQL_TYPE => 'binary', self::PDO_TYPE => PDO::PARAM_STR, self::MAX_LENGTH => '16', self::AUTO_INCREMENT => false, self::SKIP_COLUMN_IN_POST => false],
        self::FEATURE_CODE => [self::MYSQL_TYPE => 'varchar', self::PDO_TYPE => PDO::PARAM_STR, self::MAX_LENGTH => '30', self::AUTO_INCREMENT => false, self::SKIP_COLUMN_IN_POST => false],
        self::FEATURE_CREATION_DATE => [self::MYSQL_TYPE => 'datetime', self::PDO_TYPE => PDO::PARAM_STR, self::MAX_LENGTH => '', self::AUTO_INCREMENT => false, self::SKIP_COLUMN_IN_POST => true, self::DEFAULT_POST_VALUE => self::CURRENT_TIMESTAMP],
    ];
