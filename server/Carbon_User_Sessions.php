 ...
 *  static method.
 */
class Carbon_User_Sessions extends Rest implements iRestSinglePrimaryKey
{
    ...
    public const TABLE_NAME = 'recycling_carbon_user_sessions';
    ...
    **/
    ...
    /**
     * COLUMNS
     * The columns below are a 1=1 mapping to the columns found in recycling_carbon_user_sessions. 
    ...
    **/
    public const USER_ID = 'recycling_carbon_user_sessions.user_id'; 

    public const USER_IP = 'recycling_carbon_user_sessions.user_ip'; 

    public const SESSION_ID = 'recycling_carbon_user_sessions.session_id'; 

    public const SESSION_EXPIRES = 'recycling_carbon_user_sessions.session_expires'; 

    public const SESSION_DATA = 'recycling_carbon_user_sessions.session_data'; 

    public const USER_ONLINE_STATUS = 'recycling_carbon_user_sessions.user_online_status'; 
     ...
     *
     *    public Carbon_User_Sessions $recycling_carbon_user_sessions;
     *
     * The definition above can be defined with the following ::
     *
     *    $recycling_carbon_user_sessions = new Carbon_User_Sessions($return);
     *
    ...
    **/
    public const PRIMARY = 'recycling_carbon_user_sessions.session_id';
