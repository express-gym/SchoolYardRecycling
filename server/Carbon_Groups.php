 ...
 *  static method.
 */
class Carbon_Groups extends Rest implements iRestSinglePrimaryKey
{
    ...
    public const TABLE_NAME = 'recycling_carbon_groups';
    ...
    public const INTERNAL_TABLE_CONSTRAINTS = [
        self::ENTITY_ID => Carbon_Carbons::ENTITY_PK,
        self::CREATED_BY => Carbon_Carbons::ENTITY_PK,
    ];
    ...
    **/
    ...
    /**
     * COLUMNS
     * The columns below are a 1=1 mapping to the columns found in recycling_carbon_groups. 
    ...
    **/
    public const GROUP_NAME = 'recycling_carbon_groups.group_name'; 

    public const ENTITY_ID = 'recycling_carbon_groups.entity_id'; 

    public const CREATED_BY = 'recycling_carbon_groups.created_by'; 

    public const CREATION_DATE = 'recycling_carbon_groups.creation_date'; 
     ...
     *
     *    public Carbon_Groups $recycling_carbon_groups;
     *
     * The definition above can be defined with the following ::
     *
     *    $recycling_carbon_groups = new Carbon_Groups($return);
     *
    ...
    **/
    public const PRIMARY = 'recycling_carbon_groups.entity_id';
    ...
    **/
    public const PDO_VALIDATION = [
        self::GROUP_NAME => [self::MYSQL_TYPE => 'varchar', self::PDO_TYPE => PDO::PARAM_STR, self::MAX_LENGTH => '20', self::AUTO_INCREMENT => false, self::SKIP_COLUMN_IN_POST => false],
        ...
        self::CREATED_BY => [self::MYSQL_TYPE => 'binary', self::PDO_TYPE => PDO::PARAM_STR, self::MAX_LENGTH => '16', self::AUTO_INCREMENT => false, self::SKIP_COLUMN_IN_POST => false],
